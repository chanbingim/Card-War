...
{
    private PlayerDataManager        _PlayerDataMgr = null;
    ...
    #region PlayerMgr
    public bool         IsPlayerTurn() { return _PlayerDataMgr?.IsPlayerTurn() ?? false; }
    public PlayerData   GetLoaclPlayer() { return _PlayerDataMgr?.LocalPlayer; }
    public UI_CardData  DrawCard() { return _PlayerDataMgr?.Draw_Card() ?? null; }
    #endregion
    ...
    public void Initialize()
    {
        ...
        participants.Add(_PlayerDataMgr.LocalPlayer);
    ...
    {
        _PlayerDataMgr = PlayerDataManager.Create(_Cur_Stage);
        return _PlayerDataMgr != null ? true : false;
    }
